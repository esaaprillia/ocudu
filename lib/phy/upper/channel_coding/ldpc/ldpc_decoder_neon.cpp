...
ldpc_decoder_neon::ldpc_decoder_neon(bool cfg_force_decoding, bool cfg_early_stop_syndrome) :
  ldpc_decoder_impl(cfg_force_decoding, cfg_early_stop_syndrome), help_check_to_var(MAX_NODE_SIZE_NEON * NEON_SIZE_BYTE)
{
}
